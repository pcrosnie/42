...
/*   Updated: 2015/12/20 15:23:41 by rdieulan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_fill_sol_tab(t_noeud *ptr)
{
	...
	g_sol_tab[ft_count_pieces(g_ref_tab)] = NULL;
}
...
int		ft_check_sol(t_noeud *ptr)
{
	...
	n = ft_search_range(ft_count_pieces(g_ref_tab));
