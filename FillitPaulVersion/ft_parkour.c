...
/*   Updated: 2016/01/07 13:28:03 by pcrosnie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fillit.h"

int		ft_sol_range(void)
{
	int nbp;
	int i;
	int range;
...
void	ft_parkour(t_noeud *tree, int i, int sol_range)
{
	...
	while (tree->next[i])
		ft_parkour(tree->next[i++], 0, ft_check_sol(tree));
}
